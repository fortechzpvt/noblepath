...
const securityHeaders = [
  ...
  // geolocation=(self): the single-trip form's "Use my current location" (D-25).
  // Same-origin only, and the browser still asks the traveller every time; no
  // third-party frame can request it.
